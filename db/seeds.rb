...
Journo1 = Journalist.create(first_name: 'Anna', last_name: 'Hodgekiss', twitter: 'annahodgekiss')
Journo2 = Journalist.create(first_name: 'Lucy', last_name: 'Thackray', twitter: 'LucyThack')
Journo3 = Journalist.create(first_name: 'Matt', last_name: 'Chorley', twitter: 'MattChorley')
Journo4 = Journalist.create(first_name: 'Katie', last_name: 'Allen', twitter: 'KatieAllenGdn')
Journo5 = Journalist.create(first_name: 'Ian', last_name: 'Black', twitter: 'ian_black')
